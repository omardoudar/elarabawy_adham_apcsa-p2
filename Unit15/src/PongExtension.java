...
public class PongExtension extends Canvas implements KeyListener, Runnable
{
   ...
   public void setNewSideBlocks()
   {
	   sideBlocks=new ArrayList<Block>();
		...
		{
			sideBlocks.add(new Block(5, vertPos, 35, 75, Color.ORANGE));
			sideBlocks.add(new Block(45, vertPos, 35, 75, Color.ORANGE));
			sideBlocks.add(new Block(725, vertPos, 35, 75, Color.ORANGE));
			sideBlocks.add(new Block(765, vertPos, 35, 75, Color.ORANGE));
		}
		for (int hPos=85; hPos<700; hPos+=80)
		{
			sideBlocks.add(new Block(hPos, 5, 75, 35, Color.ORANGE));
			sideBlocks.add(new Block(hPos, 45, 75, 35, Color.ORANGE));
			sideBlocks.add(new Block(hPos, 485, 75, 35, Color.ORANGE));
			sideBlocks.add(new Block(hPos, 525, 75, 35, Color.ORANGE));
		}

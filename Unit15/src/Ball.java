...
public class Ball extends Block implements Collidable
{
   ...
   public void moveAndDraw(Graphics window)
   {
	...
	public boolean leftCollision(Object obj)
	{
	...
	public boolean rightCollision(Object obj)
	{
		Block other = (Block)obj;
		return (getX() < (other.getX() + other.getWidth() + Math.abs(getXSpeed()))
				&& getX() >= (other.getX() - getWidth() - Math.abs(getXSpeed()))
	...
	public boolean bottomCollision(Object obj)
	{
		Block other = (Block)obj;
	...
	public boolean topCollision(Object obj)
	{
		
		Block other = (Block)obj;
		return (getY() <= (other.getY() + other.getHeight() + Math.abs(getYSpeed()))
				&& getY() > (other.getY() - getHeight() - Math.abs(getYSpeed()))
				&& getY()<=(other.getY())
				&& getX()<(other.getX()+other.getWidth())
				&& (getX()+getWidth())>other.getX());
	}
